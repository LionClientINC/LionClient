...
Community-focused custom client with a custom base, dual ClickGUI styles, and a focused module set.

> LionClient was built partially with AI assistance and uses examples from certain versions of Raven.
